...
"""
'''
# A neural network model using One hot Encoding. You need to specify the input file on the following line:
...
#model.add(keras.layers.GlobalAveragePooling1D())#one-hot
