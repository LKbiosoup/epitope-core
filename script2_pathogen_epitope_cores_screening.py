...
This script is executed to remove redundancy after obtaining the initial antigen epitope core. The following three lines need to be changed
 ...
 line 296: file='E:/imm/file3.csv'     # File3 contains all pathogen epitopes, which can be found in the https://github.com/LKbiosoup/epitope-core 

 line 314 lis5=out_ry3(lis2,'E:/imm/file4.csv','E:/imm/core_spices.txt') #File4 contains  pathogen epitopes and their species information ，which can be found in the https://github.com/LKbiosoup/epitope-core
 #/Core_ Spices. txt is the output file path that needs to be specified, which contains information about the epitope core and the species involved.
 # In the running results, list liss4 contains the core of the pathogen epitopes and the corresponding number of occurrences in the pathogen epitope. List score represents the coverage of the core over the entire pathogen epitope library
...
lis5=out_ry3(lis2,'E:/imm/inf_dis.csv','E:/imm/core_sp2.txt')
