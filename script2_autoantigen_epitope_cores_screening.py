# -*- coding: utf-8 -*-
"""
Created on Mon Nov 20 11:43:57 2023
...
This script is executed to remove redundancy after obtaining the initial antigen epitope core. The following three lines need to be changed
 line 302: runfile='E:/imm/run.txt'  # Runfile is the running record file for demo1
 line 303: file='E:/imm/file5.csv'     # File3 contains all autoantigen epitopes, which can be found in the https://github.com/LKbiosoup/epitope-core 
